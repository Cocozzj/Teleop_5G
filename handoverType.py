...
filename='CHICAGOAIRPORT-M4-1S-HO'
...
for type in type_total:
    if type=='LTE':
        ...
        durationInfo_index.extend((NR_SA_CONFIGURATION_TIME_NR2NR))
...
def event_dur_each(dataframe):
    duration=dataframe.iloc[-len(durationInfo.columns.values.tolist()):]
    print()
