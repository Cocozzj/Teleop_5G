...
if __name__ == '__main__':
    fullDataset = pd.read_csv(path.join(DATA_DIR, 'full-dataset.csv'),low_memory=False)
    ...
    plt.tight_layout()
    plt.savefig(path.join(TASK1_DIR, 'violin-UL-general.png'))
    plt.close()
    ...
    plt.savefig(path.join(TASK1_DIR, 'violin-DL-general.png'))
    plt.close()